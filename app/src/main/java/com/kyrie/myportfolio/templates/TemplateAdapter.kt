...
class TemplateAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): TemplateHolder {
        val binding =
    ...
    class TemplateHolder(private val binding: ItemTemplateBinding) :
        ...
        fun bind(item: TemplateData, onClick: (String) -> Unit, onDownloadClick: (String) -> Unit) {
    ...
    object TemplateDiffUtil : DiffUtil.ItemCallback<TemplateData>() {
        override fun areItemsTheSame(oldItem: TemplateData, newItem: TemplateData): Boolean {
            return oldItem.name == newItem.name
        }

        override fun areContentsTheSame(oldItem: TemplateData, newItem: TemplateData): Boolean {
            return oldItem.name == newItem.name &&
